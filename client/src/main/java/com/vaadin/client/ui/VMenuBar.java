...
public class VMenuBar extends FocusableFlowPanel implements
        ...
        SubPartAware, MouseOutHandler, MouseOverHandler {
    ...
    private Map<String, List<Command>> triggers = new HashMap<String, List<Command>>();
    ...
    public static class CustomMenuItem extends Widget
        ...
        public TooltipInfo getTooltip() {
            ...
            final TooltipInfo tooltipInfo = new TooltipInfo(description, null, this);
            tooltipInfo.setContentMode(descriptionContentMode);
            return tooltipInfo;
        }
    ...
    public HandlerRegistration addTrigger(final Command command,
        ...
        final Map<String, List<Command>> triggers = getTriggers();
        if (triggers.get(partInformation) == null) {
            triggers.put(partInformation, new ArrayList<Command>());
        }
        triggers.get(partInformation).add(command);
